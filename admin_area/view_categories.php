...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="container">
      <div class="order-detail-header"><a href="manage_categories.php">Adauga categorie noua</a></div>
      <table id="table_field">
        ...
        <tbody>
          <?php
          $q = mysqli_query($con, "SELECT * FROM categorii");
          ...
          ?>
            <tr>
              ...
              <td><?= $row['denumire'] ?></td>
              <td>
                <a href="manage_categories.php?id=<?= $row['ID'] ?>" class="buttons">Edit</a>
