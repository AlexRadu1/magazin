...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 10, 2023 at 02:10 PM
...
CREATE TABLE IF NOT EXISTS `branduri` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `denumire` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `branduri` (`ID`, `denumire`, `website`) VALUES
(1, 'Nike', 'https://www.nike.com/ro/'),
(2, 'Puma', 'https://eu.puma.com/'),
(3, 'Adidas', 'https://www.adidas.com/ro/adidasrunners'),
(4, 'Denim', 'https://denim-store.ro/'),
(5, 'Calvin Klein', 'https://ro.calvinklein.com/'),
(8, 'levi\'s', 'https://www.levi.com/RO/en/');
...
CREATE TABLE IF NOT EXISTS `clienti` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `nume` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prenume` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresa` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_judet` int NOT NULL,
  `localitate` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `zipcode` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `telefon` varchar(12) COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_facturare` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(30, 'Alex', 'Adi', 'Str sorilor,34', 10, 'Brasov', '272271', '7286775474', 'Alex Adi, Str sorilor,34, Brașov , Brasov , 272271', 1),
(31, 'Alex', 'Adi', 'Str sorilor,34', 10, 'Brasov', '272271', '7286775474', ' , , , ,', 1),
(32, 'Alex', 'Adi', 'Str sorilor,34', 10, 'Brasov', '272271', '7286775474', 'Alex Adi, Str sorilor,34, Brașov , Brasov , 272271', 1);
...
CREATE TABLE IF NOT EXISTS `comenzi` (
  ...
  `metoda_plata` enum('Ramburs la livrare','Card bancar') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '1(ramburs),2(card)',
  PRIMARY KEY (`ID`),
...
(16, 30, 1125.3, 1, '2023-09-13 19:06:36', 'Ramburs la livrare'),
(17, 31, 100, 1, '2023-10-16 15:37:57', 'Ramburs la livrare'),
(18, 32, 225.06, 1, '2023-10-27 15:42:13', 'Ramburs la livrare');
...
(21, 15, 11, 5, 225, 1125),
(22, 15, 15, 2, 100, 200),
(23, 16, 12, 4, 225.06, 900.24),
(24, 16, 27, 1, 225.06, 225.06),
(25, 17, 28, 1, 100, 100),
(26, 18, 12, 1, 225.06, 225.06);
...
CREATE TABLE IF NOT EXISTS `comenzi_status` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `denumire` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `furnizori` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `denumire` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresa` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_judet` int NOT NULL,
  `IBAN` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `Banca` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(9, 4, '443405720_315649957_ck-curea.png'),
(10, 1, '829477181_png-clipart-nike-air-max-nike-free-air-force-shoe-nike-white-outdoor-shoe-thumbnail.png');
...
CREATE TABLE IF NOT EXISTS `intrarifacturi` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `serie` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nr` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_furnizor` int NOT NULL,
  `data` date NOT NULL,
  `TVA` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nr_aviz` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pret_total` float NOT NULL,
  PRIMARY KEY (`ID`),
...
(28, '7', '7', 1, '2023-10-05', '7', '7', 0),
(29, '7', '7', 1, '2023-10-05', '7', '7', 0);
...
CREATE TABLE IF NOT EXISTS `judete` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `denumire` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE IF NOT EXISTS `produse` (
  ...
  `produs_imagine1` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`ID`),
...
(1, 'Shoes', 1, 1, 225.06, 'Nike running shoes.', 'shoes running red black 40 41 42 43 44 45 39 38 37 36 adidasi alergat rosu negru ', 4, 'png-clipart-nike-air-max-nike-free-air-force-shoe-nike-white-outdoor-shoe-thumbnail.png'),
(2, 'Blue Shoes', 1, 1, 100, '123', 'blue ', 4, 'png-clipart-sneakers-skate-shoe-nike-one-nike-shoe-purple-fashion-thumbnail.png'),
(3, 'Tshirt', 4, 3, 10, 'Tricou negru 100% bumbac', 'tshirt\r\n', 11, '627619864_552209067_833012757_denim.png'),
...
CREATE TABLE IF NOT EXISTS `utilizatori` (
  ...
  `nume` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `prenume` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `telefon` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresa` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `cod_judet` int NOT NULL,
  `Oras` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `zipcode` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tip` enum('0','1') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'user(0),admin(1)',
  PRIMARY KEY (`ID`),
  KEY `cod_judet` (`cod_judet`)
...
(1, 'admin', 'c93ccd78b2076528346216b3b2f701e6', 'admin', 'Alex', 'Adi', '7286775474', 'Str sorilor,34', 10, 'Brasov', '272271', '1'),
(2, 'user1', '24c9e15e52afc47c225b757e7bee1f9d', 'user1@gmail.com', 'Alex', 'Manuc', '7286775475', 'Str sorilor,34', 10, 'Brasov', '272272', '1'),
